...
const RestaurantScreen = ({ navigation }) => {
  ...
  return (
    <View className='h-full'>
      <View className='bg-red-800 h-16 flex flex-row'>
      ...
      <ScrollView >
        <View className='pt-8 bg-red-800 h-screen ' style={{ height: '100%' }}>
          {/* <SafeAreaView /> */}
          ...
          <AboutContainer className='bg-white  top-10  rounded-tr-3xl rounded-tl-3xl mb-11' style={{ borderTopRightRadius: 100, borderTopLeftRadius: 100 }}>
            ...
            <View style={{ flex: 2, width: 400, height: 1270, marginTop: 8, top: 20 }}>
              ...
              <View className='flex flex-row p-4 justify-around flex-wrap top-8 mb-10 '>
          ...
          <View className=' flex flex-col justify-center items-center'>
            <View className='flex flex-row'>
              <Image style={{ height: 60, width: 60 }} source={require('./logo.png')} />
              <Text className='mt-5 text-lg text-yellow-400'>Bongo Dish</Text>
            </View>
            <Text className='mt-7 ml-3 bottom-2'>Copy right @Bibhas 2024</Text>
          </View>
        </View>
      </ScrollView>
    </View>
